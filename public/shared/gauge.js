(function () {
    ...
    class ScadaGauge {
        constructor(containerId, options = {}) {
            ...
            this.title = options.title ?? "CHỈ SỐ";
                    ...
                    <div class="scada-gauge-container">
                        <svg viewBox="35 28 230 260" preserveAspectRatio="xMidYMid meet">
                            <g transform="rotate(135,150,175)">
                                <circle r="100" cx="150" cy="175" fill="#ffffff"></circle>
                            ...
                            <g class="gauge-needle">
                                <polygon points="150,172 240,175 150,178" fill="#334155"></polygon>
                                <circle cx="150" cy="175" r="12" fill="#334155"></circle>
                                <circle cx="150" cy="175" r="5" fill="#ffffff"></circle>
                            </g>

                            <text fill="#0f172a" font-size="15" font-weight="700" font-family="Arial">
                                <tspan x="150" y="55" text-anchor="middle">${this.title}</tspan>
                            </text>

                            <text fill="#475569" font-size="15" font-family="Arial">
                                <tspan x="150" y="210" text-anchor="middle">${this.unit}</tspan>
                            </text>

                            <text fill="#0f172a" font-size="25" font-weight="700" font-family="Arial">
        ...
        buildApiUrl() {
            ...
            if (this.api.url) return this.api.url;
